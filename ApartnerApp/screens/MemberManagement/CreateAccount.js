  ...
  const continueEnableUser = async () => {
    ...
    try {
      ...
      if (saveUpdateEmergencyData.data.body.updateUserData != null) {
        ...
        saveUpdateEmergencyData.data.body.isPrimaryPhoneNumberUnique == false
      ) {
        displayNotification(
          'error',
          ...
          <View style={styles.maincontainer}>
            <View style={styles.formContainer}>
              <View style={styles.textTopContainer}>
                <Text style={styles.discripctionText}>
                  A new user account will be created linked to the email{' '}
                  {enabledUserData != undefined ? enabledUserData.email : ''}
                </Text>
              </View>
