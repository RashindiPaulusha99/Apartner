...
const VisitorManagement = ({navigation, loggedInUserData, unitsOfUser}) => {
        ...
        <SignInSingUpContainer>
          <KeyboardAvoidingView
            ...
            <View style={styles.memberType}>
              <Text style={styles.subtitileText}>Visiting Date</Text>
              <DatePicker
            ...
            <View style={styles.relationshipContainer}>
              <Text style={styles.subtitileText}>Unffit</Text>
              <ScrollView
            ...
            <View style={styles.textAreaContainer}>
              <Text style={styles.subtitileText}>Visitor Name</Text>
              <TextInput
                style={styles.textArea}
                underlineColorAndroid="transparent"
                onChangeText={text => {
                  setName(text != '' ? text : false);
                }}
                placeholderTextColor="grey"
                onFocus={() => setEnableShift(true)}
              />
              <Text style={styles.subtitileText}>NIC</Text>
              <TextInput
                style={styles.textArea}
                underlineColorAndroid="transparent"
                // placeholder="Description"
                onChangeText={text => {
                  setNic(text != '' ? text : false);
                }}
                placeholderTextColor="grey"
                onFocus={() => setEnableShift(true)}
              />
