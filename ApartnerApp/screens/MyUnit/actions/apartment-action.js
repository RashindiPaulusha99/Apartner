...
export const SET_MY_UNIT_SUMMERY = 'SET_MY_UNIT_SUMMERY';
...
const setMyUnitSummeryData = (dataset) => ({
  type: SET_MY_UNIT_SUMMERY,
  dataset,
});

export const setMyUnitDataAction = (dataset) => {
  return async (dispatch) => {
    dispatch(setMyUnitSummeryData(dataset));
  }
}
