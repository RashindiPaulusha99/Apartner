...
const ConfirmPassword = ({
  ...
  const [secureTextEntryConfirmNewPassword, setSecureTextEntryConfirmNewPassword] = useState(true);
  ...
  }, [loggedInUserData, signUpUserData]);
    ...
    if (!userPassword || !confirmPassword) {
      ...
      if (userPassword === confirmPassword) {
        if (userPassword.length < 8) {
          ...
          setSpinner(true);
          const setPassword = await resetPasswordApi(userData);
          let response = setPassword.data.body;
  ...
  const visiblityPasswordConfirmNewPassword = () => {
    setSecureTextEntryConfirmNewPassword(!secureTextEntryConfirmNewPassword);
  };
            ...
            <View style={styles.topCardMaincontainer}>
              ...
              <View style={styles.mainContentContainer}>
                <View style={{alignItems: 'center', marginTop: 20}}>
                  ...
                  <Text style={styles.titleBoldText}>Reset Password</Text>
                        ...
                        rightIcon={
                          secureTextEntryConfirmNewPassword
                            ? {
                                ...
                                color: '#84C7DD',
                                onPress: () => {
                                  visiblityPasswordConfirmNewPassword();
                                },
                              }
                            : {
                                type: 'font-awesome',
...
const mapStateToProps = state => ({
  ...
  signUpUserData: state.signUpState,
});
